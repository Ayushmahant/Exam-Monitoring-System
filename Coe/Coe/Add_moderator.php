...
<body>
    <div class="body_of_login_page">
        <div class="simple_form_box">
            ...
            <h1 class="coe_options">Add Moderator</h2><br>
                <hr>

                <div class="div-box">
                    <form class="user" action="Backend/coe_addmoderator.php" method="post"> 
                        ...
                        <input list="users" class="box-input five" placeholder="Add Course name" name="coursename" pla> --><br><br>
                        <!-- <hr> -->
                ...
                <option value="Artifical Intelligence & Machine Learning">
                    ...
                    <div class="submit">
                    <!-- <button class="button_one one_four">Submit</button> -->
                    <input type="submit" class="button_one one_four" value="Submit" name="">
                </div>
