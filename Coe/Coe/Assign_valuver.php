...
?>
    ...
    <div class="body_of_login_page">
        <div class="simple_form_box">
            ...
            <h1 class="coe_options">Assign Valuer</h2><br>
...
<form class="form_box" method="post" action="Backend/assign_val.php">
 <label class="info" for="user_name">Course code:</label>

                        <input name="code" list="users" class="box-input seven" placeholder="Add Course code"  pla><br><br>
                        
                        <label class="info" for="user_name">Valuer name:</label>

                        <input  list="valuers" class="box-input five" placeholder="Add Valuer name" name="name" pla><br><br>
