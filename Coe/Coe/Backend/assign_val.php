...
$fet_code = "SELECT * FROM valuer where name = '$name'";
...
$query = "UPDATE valuer SET coursename = '$codes_name_str',coursecode = '$codes_str' WHERE name = '$name' ";
...
<script type="text/javascript">
	alert("Coursecode assigned Successfully");
		window.location = "../Assign_valuver.php";
